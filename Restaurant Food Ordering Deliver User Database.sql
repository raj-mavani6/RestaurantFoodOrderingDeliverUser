...
(1, 1, 'Amit Singh', '9876543212', '789 CG Road, Ahmedabad', 'Assigned', 547.00, 45.00, 0.00, 6.10, 'Online', 'Paid', DATE_SUB(NOW(), INTERVAL 1 DAY), NULL, NULL);
